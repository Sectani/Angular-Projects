...
export class ProductServicesService {
  ...
  public applyDiscount(status : boolean, percentage : number) : Observable<any>{
    return this.http.post<any>(`http://localhost:9090/products/make-offer/${status}/${percentage}`,{});
  }
